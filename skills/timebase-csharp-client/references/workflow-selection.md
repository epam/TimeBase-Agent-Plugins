...
| Bound read/write | typed cursor/loader | `cursor-and-streams.md`, `examples/read-write-bound.md` |
| Stream creation + loader writes | schema + loader | `message-types-and-schema.md`, `examples/create-stream.md` |
| QQL with bound .NET results | QQL bind | `qql-bound-queries.md`, `examples/qql-query-result.md` |
| C# that lists streams | connect fragment | `examples/connect-list-streams.md` |
| Live cursor | live select | `cursor-and-streams.md`, `examples/live-cursor.md` |
| OAuth2  | auth | `authentication.md`, `examples/oauth2.md` |
| Large local export | narrow + stream write | `examples/large-export.md`, `cursor-and-streams.md` |
| Schema inspection in C# | descriptors | `examples/schema-introspection.md` |
